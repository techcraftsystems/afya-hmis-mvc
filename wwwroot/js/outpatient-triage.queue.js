    ...
    jq.ajax({
        ...
        success: function(results) {
            ...
            jq.each(results, function(i, bl) {
                var iStatus = (bl.seenBy.id == 0 ? "In Queue" : "Being Seen");
                var iIcons = '&nbsp; <a href="/outpatient/triage?qid=' + bl.id + '"><i class="feather icon-airplay td-action"></i></a> <a class="pointer redirect-link" data-idnt="' + bl.id + '"> <i class="feather icon-x danger td-action"></i></a>';
